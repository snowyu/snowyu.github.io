---
author: riceball
date: 2012-04-24 18:38:00+08:00
updated: 2012-04-24 18:38:00+08:00
...
而这一切需要某种能让参与各方都能得到信任平台，这个平台也应该是各方共建的平台。
...
信的傻事，不过没人在乎。而再比如T宝来说，T宝最开始是提供开放的API接口的，但是自从15年开始，API不再开放了,大
部分转为开始收费，哪怕是页面公开的产品信息，如果通过API调用获取也要收费，所以大家开始页面爬虫抓取。14年的时候
比价网比比皆是，到如今所剩无几。一边说让天下没有难做的生意，一边却想方设法阻碍信息的分享和流通。
...
当前，几乎所有提供分享经济服务的平台在应对信任问题时，都采取了“评分”机制。租借双方都必须填写详细的个人数据，
在分享活动结束后，可以给对方评分。但是这样的“评分”仅限于平台内部，当然，这个“分数”也不会有任何的分享，或者保
...
针对参与各方的开放，信任，权益的公平分配是下一代分享经济急需解决的主要问题。

我的主张是下一代分享经济平台首先是通过开源解决开放和信任问题：

* 从技术上，代码完全透明，避免员工（或公司）在代码内置后门
* 代码的迭代开发审核，完全是由业内专家组织，而不是职员任务。
* 从商业上，保证代码是属于参与各方大家的共有财产。
* 从商业上，保证各个功能都是满足各方需求(或者说是各方共同参与PK)的产物
* 从商业上，保证规则的制定也是如此

“开源”是分享经济的最佳载体，没有之一。因为“开源”的本质是共享“技术”，而“技术”是生产资料的组成部分，这是由市场驱动而“自发形成”的部分生产资料的“公有制”。当然这里的“开源”还包括是“运作”的“开源”，以此确保运行时刻的各方利益。只有这样的平台才能够是自洽的，自我进化的，能够在博弈中满足各方需求的。
